...
<div class="container">
  <header class="border-bottom lh-1 py-3">
    ...
    <div class="col-4 text-center">
        <a class="blog-header-logo text-body-emphasis text-decoration-none" href="#">BLOG DENGAN CI 3</a>
      </div>
  ...
  <div class="nav-scroller py-1 mb-3 border-bottom">
    <nav class="nav nav-underline justify-content-between">
      <a class="nav-item nav-link link-body-emphasis active" href="{{ site_url('/') }}">Home</a>
    </nav>
  </div>
</div>
